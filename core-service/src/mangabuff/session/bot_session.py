...
class BotSession:
    ...
    #
    # priority — та сама шкала, що живе в account-service
    # (account_service/transport/proxy_queue.py): AUTH / TIME_CRITICAL /
    # CRITICAL / NORMAL / BACKGROUND. AUTH зарезервовано для account-service
