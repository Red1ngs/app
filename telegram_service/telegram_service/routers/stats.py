...
from telegram_service.nav import nav_answer
...
async def cmd_stats(message: Message, state: FSMContext, svc: CoreServiceClient) -> None:
...
async def cb_stats_account(call: CallbackQuery, svc: CoreServiceClient) -> None:
